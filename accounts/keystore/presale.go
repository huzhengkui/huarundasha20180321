...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/plcereum/pyplcsaletool

		pyplcsaletool generates the encryption key from password by
	...
	*/
	...
	plcPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(plcPriv)
	...
	expectedAddr := preSaleKeyStruct.plcAddr
